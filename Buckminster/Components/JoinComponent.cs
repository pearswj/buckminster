...
{
    public class JoinComponent : GH_Component
    {
        /// <summary>
        ...
        public JoinComponent()
            : base("Buckminster's Join Component", "Join",
                "Applies Conway's join operator to the input mesh.",
                "Buckminster", "Conway")
        {
        }
        ...
        {
            get { return new Guid("{7a0dc73c-8f62-4b9c-9528-e7421ae3b5b3}"); }
        }
    }
}